...
import com.shencangblue.design.icrs.filter.URLPathMatchingFilter;
import com.shencangblue.design.icrs.realm.ICRSRealm;
...
public class ShiroConfiguration {
    ...
    @Bean
    public ICRSRealm getICRSRealm() {
        ICRSRealm icrsRealm = new ICRSRealm();
        icrsRealm.setCredentialsMatcher(hashedCredentialsMatcher());
        return icrsRealm;
    }
